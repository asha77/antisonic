...
def tbl_files_info_out2scr():
    ...
    print("     - compliance_output.csv     - results of compliance checks")
    print("     - all_macs.csv              - all MACs from all switches (without deduplication)")
    print("     - absent_macs.csv           - MACs that present only on one switch in pair (filtered)")
    print("     - same_stated_macs.csw      - MAC entries with the same state (static/static or dynamic/dynamic) on pair of switches")
...
def print_devices_errors(devices):
    for dev in devices:
        print('====================================== ERRORS ON {0:20s} ===================================='.format(dev['hostname']))

        for error in dev['errors']:
            print('{0:100s}'.format(error))
